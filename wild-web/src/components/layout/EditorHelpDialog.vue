  ...
  <Teleport to="body">
      <Transition name="wild-help-modal">
        ...
        <section>
          <h3>环境渲染效果</h3>
          <ul>
            <li>视口工具栏新增一组环境效果开关：<strong>云层、积水、波纹、沙尘、体积雾、反射</strong>，默认全部关闭，低端设备保持关闭即可不影响性能。</li>
            <li>“云层”由云量和风力驱动，随时间漂移，多云和阴天的天空不再只有灰蒙蒙一层；“沙尘”开关会为沙尘天气增加空中尘粒。</li>
            <li>雨天开启“积水”后地面低洼处会形成水洼，开启“波纹”后雨滴在水面产生动态涟漪，开启“反射”后水面降低粗糙度并反射环境。</li>
            <li>“体积雾”把线性雾切换为指数雾，雾天和沙尘的近景空气透视更明显。</li>
            <li>太阳在白天清晰可见，并带有光晕；云、雾和降雨会自然降低其亮度。</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>新增环境效果开关：可见云层、雨地积水、雨滴波纹、沙尘粒子、体积雾与积水面反射，默认全部关闭，低端设备不受影响。</li>
            <li>增强太阳可见性：白天太阳呈现明亮日轮并带光晕，不再难以辨认。</li>
            <li>云层由云量和风力驱动并随时间漂移；沙尘天气新增空中尘粒；雨天地面低洼处积水，雨滴在水面产生动态波纹。</li>
