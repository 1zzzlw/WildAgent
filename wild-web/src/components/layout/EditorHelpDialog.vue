      ...
      <Transition name="wild-help-modal">
        ...
        <section>
          ...
          <ul>
            ...
            <li><strong>程序化 Shader</strong>不依赖图片，由代码生成砖块、灰缝、凹凸、色差和风化效果；当前已实现的类型只有 <code>brick</code>。</li>
            <li>“新红砖、自然旧红砖、潮湿盐碱红砖”是同一 <code>brick</code> Shader 的语义配方，不是三个渲染类型。</li>
            <li>AI 聊天栏中的 <strong>Shader</strong> 开关默认关闭；只有用户显式开启后，AI 才会自动生成程序化纹理。手动编辑已有材质不受该开关影响。</li>
